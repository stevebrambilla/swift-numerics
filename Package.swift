...
let package = Package(
  ...
  name: "swift-numerics",
  products: [
    .library(name: "ComplexModule", type: .dynamic, targets: ["ComplexModule"]),
    .library(name: "Numerics", type: .dynamic, targets: ["Numerics"]),
    .library(name: "RealModule", type: .dynamic, targets: ["RealModule"]),
  ],
